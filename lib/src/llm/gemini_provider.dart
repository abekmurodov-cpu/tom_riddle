...
class GeminiProvider implements LlmProvider {
  ...
  Future<McQuiz> generateQuiz(KnowledgeItem item,
    ...
    final raw = await _generate(
      ...
      'Rules:\n'
      '- "question": a clear question that TESTS the note. If the note is not '
      'already a question (a fact, a code snippet, a command, or a concept/term), '
      'REWRITE it as a question — never just echo the note content back. '
      'For code or commands, ask what it does or outputs. Examples: '
      '"Water boils at 100°C" -> "At what temperature does water boil?"; '
      'a Python snippet reversing a list -> "What does this code do?"; '
      '"git reset --hard" -> "Which git command discards all local changes?". '
      'If the note is already phrased as a question, keep it.\n'
      '- "answer": the CORRECT answer to "question", ONE short phrase/sentence '
      '(max ~15 words). Do NOT copy long explanations or long code.\n'
